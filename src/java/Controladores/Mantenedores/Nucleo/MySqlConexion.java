package Controladores.Mantenedores.Nucleo;
    ...
    public MySqlConexion(int nDato) {//host , <puerto,> bd, user, contraseña
        switch (nDato) {
            case 1://Conexion local
                dato = new DatoConexion("localhost", "sistema_ofis", "root", "");
                break;
            case 2://Conexion otro lugar IP Publica Y Puerto Publico
                dato = new DatoConexion("127.0.0.1", "sistema_ofis", "root", "");
                break;
        }
